...
def parse_arguments():
    ...
    parser.add_argument('--save_dir', type=str, default='./results/mnist_inference', help='結果の保存先')
    parser.add_argument('--seed', type=int, default=42, help='乱数シード')
    parser.add_argument('--model_path', type=str, default=None, help='事前学習済みモデルのパス')
