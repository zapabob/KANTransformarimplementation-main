...
def parse_arguments():
    ...
    parser.add_argument('--transfer_learning', action='store_true', help='転移学習を有効にする')
    parser.add_argument('--source_model', type=str, default=None, help='転移学習元のモデルパス')
    parser.add_argument('--save_dir', type=str, default='results/mnist_training',
                      help='結果の保存ディレクトリ')
